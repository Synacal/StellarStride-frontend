...
import FileUploadInputField from '../components/Common/file-uploader-input';
			...
			<div className="w-5/6 mb-20 mx-auto pt-8 px-4 rounded-2xl bg-[#CBCBCD] md:bg-gradient-to-b md:from-[#006B72] md:to-[#000000] flex-grow">
				...
				<div className="mt-6">
					<FileUploadInputField
						placeholderText={'Insurance policy certification'}
					/>
					<FileUploadInputField
						placeholderText={'SpacePass Documentation'}
					/>
					<FileUploadInputField
						placeholderText={'Passport Documentation'}
					/>
					<FileUploadInputField
						placeholderText={'National ID Documentation'}
					/>
				</div>
